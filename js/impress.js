    ...
    var impress = window.impress = function ( rootId ) {
        ...
        var initStep = function ( center ) {
            return function ( el, idx ) {
                ...
                css(el, {
                    position: "absolute",
                    transform: (center === false ? "" : "translate(-50%,-50%)") +
        ...
        var init = function () {
            ...
            config = {
                ...
                surfacesEnabled: !!(rootData.surfaces || defaults.surfaces)
            };
            ...
            if(config.surfacesEnabled) {
                $$(".surface", root).forEach( initStep(false) );
                // If the containers don't have overflow 'visible' the perspective looks really weird
